<template>
  <div class="home-container">
        ...
        <span class="home-text01">
          <span>
            <span>
              ...
              volutpat turpis.
              <span v-html="rawltxu"></span>
            </span>
            <span><span v-html="raw4wqp"></span></span>
          </span>
          <span>
            <span>
              Mauris luctus rutrum mi ut rhoncus. Integer in dignissim tortor.
              <span v-html="rawajd4"></span>
            </span>
            <span><span v-html="raw7med"></span></span>
          </span>
        </span>
      ...
      <h2 class="home-text08">
        <span>
          <span>
            ...
            <span v-html="raw2am3"></span>
          </span>
          <span><span v-html="raw8pz3"></span></span>
        </span>
        <br />
    ...
    <div class="home-gallery">
      <h1 class="home-text13">Our portfolio</h1>
      <span class="home-text14">
        <span>
          <span>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non
            volutpat turpis.
            <span v-html="rawwsjp"></span>
          </span>
          <span><span v-html="rawp93m"></span></span>
        </span>
        <br />
        <span>
          <span>
            Mauris luctus rutrum mi ut rhoncus. Integer in dignissim tortor.
            <span v-html="raw11th"></span>
          </span>
          <span><span v-html="raw9kuq"></span></span>
        </span>
      </span>
      <div class="home-container3">
        <gallery-card3 rootClassName="rootClassName"></gallery-card3>
        <gallery-card3
    ...
    <div class="home-banner1">
      <div class="home-btn-group1">
        ...
        <button class="home-button3 button">Learn More</button>
      </div>
    </div>
    <footer class="home-footer">
      <img
        ...
        class="home-image2"
      />
      <span class="home-text21">© 2021 teleportHQ, All Rights Reserved.</span>
...
import GalleryCard3 from './gallery-card3.vue'
